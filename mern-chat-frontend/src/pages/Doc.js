...
const Doc =()=>{
    return(
        <>
            <Banner title="Documentation " smtitle="Doc"/>
        ...
        height='70%'/></div>
                        ...
                        <div className="doc-area">
                            ...
                            <li className="exp-bx"> Décrypter les pleurs de bébé</li>
                                <li ><img className="doc-thumb2" src={img1}/></li>
                                <li><img className="doc-thumb3" src={img2} /></li>
                                <li><img  className="doc-thumb1" src={img3} /></li>
                                <li>
                                    <h6 class="parag2">
